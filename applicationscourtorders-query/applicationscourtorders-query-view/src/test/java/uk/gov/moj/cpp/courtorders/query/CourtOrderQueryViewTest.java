...
public class CourtOrderQueryViewTest {
    ...
    public void getCourtOrdersByDefendant() {
        ...
        final JsonObject courtOrderPayload = createObjectBuilder().add("id", courtOrderId.toString()).build();
    ...
    void shouldGetCourtOrdersByDefendantReturnShowUnpaidWorkWarningAsTrueWhenHearingDateIsAfterEndDate() {
        ...
        final CourtOrderEntity courtOrderEntity = new CourtOrderEntity();
        final UUID courtOrderId = randomUUID();
        final JsonObject courtOrderPayload = createObjectBuilder().add("id", courtOrderId.toString())
    ...
    void shouldGetCourtOrdersByDefendantAndOffenceDate() {
        ...
        final JsonObject courtOrderPayload2 = createObjectBuilder().add("id", courtOrderId2.toString())
                .add("isUnpaidWork", true)
        ...
        final JsonObject courtOrderPayload3 = createObjectBuilder().add("id", courtOrderId3.toString())
